...
const VALID_AMBULANCE_TRANSITIONS = {
  REQUESTED: ['ASSIGNED', 'AVAILABLE', 'OFFLINE'],
  PENDING_AMBULANCE: ['ASSIGNED', 'AVAILABLE', 'OFFLINE'],
  OFFLINE: ['AVAILABLE'],
  AVAILABLE: ['ASSIGNED', 'OFFLINE'],
  ASSIGNED: ['EN_ROUTE_TO_PATIENT', 'AVAILABLE', 'OFFLINE'],
  EN_ROUTE: ['AT_SCENE', 'AVAILABLE'],
  EN_ROUTE_TO_PATIENT: ['AT_SCENE', 'AVAILABLE'],
